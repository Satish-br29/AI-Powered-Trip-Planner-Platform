    ...
    <div className="auth-split-page">
      ...
      <div className="auth-split-image-container">
        <div 
          ...
          style={{ backgroundImage: "url(/shared_images/img2_beach.png)" }}
        />
        ...
        <div className="auth-split-quote glass-quote">
          ...
          <h2>Let's plan to travel<br/>together again</h2>
          <p>Create memories that last a lifetime with AI-powered itineraries.</p>
        </div>
      </div>
